...
<head>
    ...
    <title>Appointment Confirmed - QuickBookApp</title>
</head>
                    ...
                    <tr>
                        <td align="center" style="padding:44px 40px 24px;">
                            ...
                            <p style="margin:0; color:#6b7280; font-size:15px; line-height:1.6;">
                                We've got you booked in. Here are your appointment details below.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 40px 36px;">
                            <table width="100%" cellpadding="0" cellspacing="0"
                                   style="background-color:#f0f7ff; border:1px solid #bfdbfe;
                    ...
                    <tr>
                        <td align="center" style="padding:0 40px 40px;">
                            <p style="margin:0; color:#374151; font-size:15px; line-height:1.7;">
                                Thank you for using <strong style="color:#1a56db;">QuickBookApp</strong>!<br>
                                If you need to make any changes, please log in to your account.
                            </p>
                        </td>
                    </tr>
